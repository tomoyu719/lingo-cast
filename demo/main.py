...
def main():
    ...
    make_example_sentence = MakeExampleSentence(args.language_code)
    ...
    for i, file_name in enumerate(file_names):
        ...
        for source_word in source_words:
            ...
            example_sentence = make_example_sentence.make_example_sentence(source_word, args.max_example_sentence_length)
